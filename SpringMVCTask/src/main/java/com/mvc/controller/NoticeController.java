...
public class NoticeController {
	...
	@Autowired
	NoticeService service;// interface type
	...
	public String insertProcess(@ModelAttribute Notice n) {//클라이언트로부터 받아올 값들을 vo로 한번에 받아옴.	
		service.insert(n);
...
//		map.put("word", word);
//		
//		ArrayList<Notice> list = service.search(map);
//		model.addAttribute("list", list);
//		return "list";
//	}
//	
