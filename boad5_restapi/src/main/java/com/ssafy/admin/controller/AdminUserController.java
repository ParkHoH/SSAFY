...
public class AdminUserController {
	...
	@PostMapping("/user")
	public ResponseEntity<?> userJoin(@RequestBody MemberDto memberDto) throws Exception {
		try {
	...
	public ResponseEntity<?> userView(@PathVariable("userid") String userId) throws Exception {
		try {
