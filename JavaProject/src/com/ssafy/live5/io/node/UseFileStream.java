...
public class UseFileStream {
    ...
    private void testFile() throws IOException {
        ...
        //  프로젝트와 무관하게 파일을 찾을 때
        File readMe = new File("C:\\SSAFY\\workspace\\02_java\\JavaProject\\bin\\com\\ssafy\\live5\\io\\node\\readme.txt");
        //  프로젝트 내부에서 파일을 찾을 때
        readMe = new File("./src/com/ssafy/live5/io/node/readme.txt");
        readMe = new File("./bin/com/ssafy/live5/io/node/readme.txt"); // bin에서도 파일이 있기 때문에
